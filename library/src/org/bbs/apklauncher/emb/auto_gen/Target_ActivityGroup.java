...
/**
 *
 * provide consistent interface with {@link ActivityGroup}, but actually this 
 * is NOT a {@link ActivityGroup}, so when u want a Activity context, use
 * {@link #getHostActivity}.
 */
@SuppressLint("NewApi")
public class Target_ActivityGroup extends 
//ActivityGroup
ContextWrapper
{
//do NOT edit this file, auto-generated by host_target.groovy from Target_Activity.java.template
	private static final String TAG = Target_ActivityGroup.class.getSimpleName();
	...
	protected StubBase_ActivityGroup mHostActivity;
	
	public Target_ActivityGroup() {
		this(null);
	}
	public Target_ActivityGroup(Context base) {
		super(base);
		
		mHostActivity = (StubBase_ActivityGroup) base;
	}
//do NOT edit this file, auto-generated by host_target.groovy from Target_Activity.java.template
	
	void setHostActivity(Stub_ActivityGroup hostActivity) {
		mHostActivity = hostActivity;
	}
	
	public StubBase_ActivityGroup getHostActivity() {
		return mHostActivity;
	}
	
	//private StubBase_ActivityGroup getHostActivityFromBaseContext(Context base) {
		//return (StubBase_ActivityGroup) base;	
	//	if (base instanceof StubBase_ActivityGroup) {
	//		return (StubBase_ActivityGroup) base;
	//	}
	//	return (StubBase_ActivityGroup) ((TargetContext)base).getHostActivity();
	//}
