...
/**
 *
 * provide consistent interface with {@link TabActivity}, but actually this 
 * is NOT a {@link TabActivity}, so when u want a Activity context, use
...
ContextWrapper
{
	...
	protected StubBase_TabActivity mHostActivity;
	...
	public Target_TabActivity(Context base) {
		...
		mHostActivity = (StubBase_TabActivity) base;
	}
	
	void setHostActivity(Stub_TabActivity hostActivity) {
...
//do NOT edit this file, auto-generated by host_target.groovy from Target_Activity.java.template
	...
	//private StubBase_TabActivity getHostActivityFromBaseContext(Context base) {
		//return (StubBase_TabActivity) base;	
	//	if (base instanceof StubBase_TabActivity) {
	//		return (StubBase_TabActivity) base;
	//	}
	//	return (StubBase_TabActivity) ((TargetContext)base).getHostActivity();
	//}
