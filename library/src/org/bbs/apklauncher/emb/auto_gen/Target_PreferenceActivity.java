...
/**
 *
 * provide consistent interface with {@link PreferenceActivity}, but actually this 
 * is NOT a {@link PreferenceActivity}, so when u want a Activity context, use
...
//do NOT edit this file, auto-generated by host_target.groovy from Target_Activity.java.template
	...
	protected StubBase_PreferenceActivity mHostActivity;
	...
	public Target_PreferenceActivity(Context base) {
		...
		mHostActivity = (StubBase_PreferenceActivity) base;
	}
//do NOT edit this file, auto-generated by host_target.groovy from Target_Activity.java.template
	
	void setHostActivity(Stub_PreferenceActivity hostActivity) {
	...
	//private StubBase_PreferenceActivity getHostActivityFromBaseContext(Context base) {
		//return (StubBase_PreferenceActivity) base;	
	//	if (base instanceof StubBase_PreferenceActivity) {
	//		return (StubBase_PreferenceActivity) base;
	//	}
	//	return (StubBase_PreferenceActivity) ((TargetContext)base).getHostActivity();
	//}
