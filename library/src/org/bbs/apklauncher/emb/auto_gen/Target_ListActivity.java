...
/**
 *
 * provide consistent interface with {@link ListActivity}, but actually this 
 * is NOT a {@link ListActivity}, so when u want a Activity context, use
...
{
//do NOT edit this file, auto-generated by host_target.groovy from Target_Activity.java.template
	private static final String TAG = Target_ListActivity.class.getSimpleName();
	...
	protected StubBase_ListActivity mHostActivity;
...
//do NOT edit this file, auto-generated by host_target.groovy from Target_Activity.java.template
	...
	void setHostActivity(Stub_ListActivity hostActivity) {
	...
	//private StubBase_ListActivity getHostActivityFromBaseContext(Context base) {
		//return (StubBase_ListActivity) base;	
	//	if (base instanceof StubBase_ListActivity) {
	//		return (StubBase_ListActivity) base;
	//	}
	//	return (StubBase_ListActivity) ((TargetContext)base).getHostActivity();
	//}
