...
/**
 *
 * provide consistent interface with {@link ActionBarActivity}, but actually this 
 * is NOT a {@link ActionBarActivity}, so when u want a Activity context, use
 * {@link #getHostActivity}.
 */
@SuppressLint("NewApi")
//do NOT edit this file, auto-generated by host_target.groovy from Target_Activity.java.template
public class Target_ActionBarActivity extends 
//ActionBarActivity
ContextWrapper
{
	private static final String TAG = Target_ActionBarActivity.class.getSimpleName();
	...
	protected StubBase_ActionBarActivity mHostActivity;
	
	public Target_ActionBarActivity() {
		this(null);
	}
	public Target_ActionBarActivity(Context base) {
		super(base);
		
		mHostActivity = (StubBase_ActionBarActivity) base;
	}
	
	void setHostActivity(Stub_ActionBarActivity hostActivity) {
...
//do NOT edit this file, auto-generated by host_target.groovy from Target_Activity.java.template
	...
	//private StubBase_ActionBarActivity getHostActivityFromBaseContext(Context base) {
		//return (StubBase_ActionBarActivity) base;	
	//	if (base instanceof StubBase_ActionBarActivity) {
	//		return (StubBase_ActionBarActivity) base;
	//	}
	//	return (StubBase_ActionBarActivity) ((TargetContext)base).getHostActivity();
	//}
