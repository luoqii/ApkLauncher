...
public class TargetInstrumentation extends Instrumentation {
		...
		public void setCallBack(TargetInstrumentation.CallBack callback) {
			mCallback = callback;
		}
		...
		public static void injectInstrumentation(Activity activity, TargetInstrumentation.CallBack callback) {
			...
			TargetInstrumentation wrapper = new TargetInstrumentation(i, new Handler());
